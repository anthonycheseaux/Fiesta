...
*/
    ...
    public EventEntity get(@Named("id") Long id) throws NotFoundException {
    ...
    public EventEntity insert(EventEntity eventEntity) {
        ...
        // You should validate that eventEntity.id has not been set. If the ID type is not supported by the
        // Objectify ID generator, e.g. long or String, then you should generate the unique ID yourself prior to saving.
        //
        // If your client provides the ID then you should probably use PUT instead.
        ofy().save().entity(eventEntity).now();
        logger.info("Created EventEntity with ID: " + eventEntity.getId());
    ...
    public EventEntity update(@Named("id") Long id, EventEntity eventEntity) throws NotFoundException {
    ...
    public void remove(@Named("id") Long id) throws NotFoundException {
        checkExists(id);
        ofy().delete().type(EventEntity.class).id(id).now();
        logger.info("Deleted EventEntity with ID: " + id);
    }
    ...
    private void checkExists(Long id) throws NotFoundException {
        try {
            ofy().load().type(EventEntity.class).id(id).safe();
